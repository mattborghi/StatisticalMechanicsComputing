...
for step in range(n_steps):
    ...
    #print [-V(a,cubic,quartic) for a in x]    
    ...
    #print old_Trotter_weight,new_Trotter_weight, new_Trotter_weight/old_Trotter_weight
...
pylab.xlim(-2, 2)
pylab.savefig('plot_C1_2_beta%s.png' % beta)
pylab.show()