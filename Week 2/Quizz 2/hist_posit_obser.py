...
N = 4
sigma = 0.01 #eta = 0.18 corresponds to sigma = 0.1197
n_runs = 1000000
histo_data = []
...
pylab.title('Direct sampling: x position coordinate histogram (density eta=0.18)')
pylab.grid()
pylab.savefig('direct_disks_histo2.png')
pylab.show()