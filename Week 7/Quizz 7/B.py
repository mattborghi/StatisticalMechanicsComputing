...
for step in range(nsteps):
    ...
    while True:
        ...
        if boson_b == perm_cycle[0]:
           ...
           boson_a = boson_b
    k = len(perm_cycle)
    if k > min_cycle: hist_cycle_10 += [boson_a[0]]
...
pylab.hist(hist_cycle,normed=True,bins=50,label='histogram pos',alpha = 0.5,color='r')
pylab.hist(hist_cycle_10,normed=True,bins=50,label='histogram min cycle = 10',alpha=0.6,color='b')
pylab.legend()
